/*********************************************************************************
* FileName:		tcp_async_echo_client.cpp
* Author:		gehan
* Date:			07/15/2017
* Description:	The implementation of async connect with tcp for client
**********************************************************************************/
...
class talk_to_srv : public boost::enable_shared_from_this<talk_to_srv>
	, boost::noncopyable 
{
public:
	typedef talk_to_srv self_type;
	talk_to_srv(const std::string & message)
